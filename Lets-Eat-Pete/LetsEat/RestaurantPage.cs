...
namespace LetsEat    
{
    ...
    public class RestaurantPage : Activity
    {
        ...
        static readonly List<string> alohaReserves = new List<string>();
        static readonly List<string> lagoReserves = new List<string>();
        static readonly List<string> lemonReserves = new List<string>();
        static readonly List<string> oliveReserves = new List<string>();
        static readonly List<string> phoReserves = new List<string>();
        static readonly List<string> robertoReserves = new List<string>();
        static readonly List<string> swSteakReserves = new List<string>();
        static readonly List<string> sweetReserves = new List<string>();
        static readonly List<string> twistReserves = new List<string>();
        static readonly List<string> zumaReserves = new List<string>();
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            {
                reserveIntent.PutExtra("reserve_time", "One");
                StartActivityForResult(reserveIntent, 0);
                if (resTrack == 1) {
            ...
            {
                reserveIntent.PutExtra("reserve_time", "Two");
                StartActivityForResult(reserveIntent, 0);
            };
            /*
            mReserve3.Click += (sender, e) =>
            {
                var intentRthree = new Intent(this, typeof(ReservePage));
            };
            mReserve4.Click += (sender, e) =>
            {
                var intentRfour = new Intent(this, typeof(ReservePage));
            };
            mReserve5.Click += (sender, e) =>
            {
                var intentRfive = new Intent(this, typeof(ReservePage));
            };
            mReserve6.Click += (sender, e) =>
            {
                var intentRsix = new Intent(this, typeof(ReservePage));
            };
            mReserve7.Click += (sender, e) =>
            {
                var intentRseven = new Intent(this, typeof(ReservePage));
            };
            mReserve8.Click += (sender, e) =>
            {
                var intentReight = new Intent(this, typeof(ReservePage));
            };
            */
