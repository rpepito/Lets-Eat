...
public class Menu_MyValueEventListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("LetsEat.Menu+MyValueEventListener, LetsEat, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", Menu_MyValueEventListener.class, __md_methods);
	}


	public Menu_MyValueEventListener ()
	{
		super ();
		if (getClass () == Menu_MyValueEventListener.class)
			mono.android.TypeManager.Activate ("LetsEat.Menu+MyValueEventListener, LetsEat, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
